                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <p class="help-block text-danger">{!! $errors->first('nom', ":message") !!} </p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="email" id="email" class="form-control" placeholder="email" required="required">
                                <p class="help-block text-danger">{!! $errors->first('email', ":message") !!}</p>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <textarea name="message" id="message" class="form-control" rows="4" placeholder="message" required></textarea>
                        <p class="help-block text-danger">{!! $errors->first('message', ":message") !!}</p>
                    </div>
                    <div id="success"></div>
